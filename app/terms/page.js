    ...
    <div style={{background:c.bg,minHeight:"100vh",fontFamily:"'Instrument Sans',-apple-system,sans-serif",padding:"40px 20px"}}>
      ...
      <div style={{maxWidth:680,margin:"0 auto"}}>
        ...
        <div style={{fontSize:14,color:c.sub,lineHeight:1.8}}>
          ...
          <p>Brikk offers a 14-day free trial. After the trial period, the Pro plan is $75 per month and the Team plan is $200 per month. A one-time setup fee of $125 applies. Prices may change with 30 days notice. All fees are non-refundable except as required by law.</p>
